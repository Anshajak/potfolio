    ...
    $.fn.pagepiling = function (custom) {
        ...
        function addVerticalNavigation() {
            ...
            for (var cont = 0; cont < $('.pp-section').length; cont++) {
                ...
                nav.find('ul').append('<li data-tooltip="' + link + '"><a href="#' + link + '"><span></span></a></li>');
            }
        ...
        $(document).on({
            mouseenter: function () {
                ...
                $('<div class="hovtextleft pp-tooltip ' + options.navigation.position + '"><a href="#' + tooltip + '">' + tooltip + '</a></div>').hide().appendTo($(this)).fadeIn(200);
            },
            mouseleave: function () {
...
})(jQuery, document, window); /*!elementor - v2.9.7 - 25-03-2020*/
! function (t) {
    var e = {};
